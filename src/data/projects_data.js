const projectsData = {
  ...
  salty: {
    ...
    description: `Logotype for @Salty by Vasilis Pontikakis\n
    We designed the logotype and print materials for @Salty,
    a brand specializing in unique wedding photos.\n
    The logotype, inspired by iconic viral glasses, blends modern 
    style with timeless aesthetics, reflecting the brand’s creativity
    and innovation. With a focus on freshness and uniqueness,
    @Salty redefines the magic of wedding photography.`,
...
a harmonious and professional visual identity.`,
    text: "Branding Name - Brand Identity - Visual Identity ",
    prev_project: "modeco",
    next_project: "sfiga",
    video1: null, 
